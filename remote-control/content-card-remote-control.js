...
#remote-control {
	position: relative;
	background: url(/local/remote-back2.png) no-repeat;
	width: 224px;
	height: 507px
}
...
#remote-control li#power a {
	...
	width: 37px;
	height: 37px;
	background: url(/local/remote-home.jpg) no-repeat
}

#remote-control li#power a:hover {
	background-image: url(/local/remote-home.jpg);
...
#remote-control li#source a {
	...
	width: 37px;
	height: 37px;
	background: url(/local/remote-sitemap.jpg) no-repeat
}

#remote-control li#source a:hover {
	background-image: url(/local/remote-sitemap.jpg);
	background-repeat: no-repeat;
	background-position: 0 -37px
}
...
#remote-control li#buttonEnter a {
	width: 41px;
	height: 21px;
	background: url(/local/remote-button.jpg) no-repeat
}
...
#remote-control li#buttonEnter a:hover {
	background-image: url(/local/remote-button.jpg);
	background-repeat: no-repeat;
...
#remote-control li#exit a {
	...
	left: 41px;
	top: 331px;
	background: url(/local/remote-circle3.jpg) no-repeat 0 -19px
}
...
#remote-control li#info a {
	...
	left: 74px;
	top: 312px;
	background: url(/local/remote-circle3.jpg) no-repeat -33px 0px
}
...
#remote-control li#menu a {
	...
	left: 116px;
	top: 312px;
	background: url(/local/remote-circle3.jpg) no-repeat -75px 0
}
...
#remote-control li#back a {
	...
	left: 154px;
	top: 332px;
	background: url(/local/remote-circle3.jpg) no-repeat -113px -20px
}
...
#remote-control li#left a {
	...
	left: 58px;
	top: 365px;
	background: url(/local/remote-circle3.jpg) no-repeat -17px -53px
}
...
#remote-control li#right a {
	...
	left: 139px;
	top: 365px;
	background: url(/local/remote-circle3.jpg) no-repeat -98px -53px
}
...
#remote-control li#top a {
	...
	left: 80px;
	top: 342px;
	background: url(/local/remote-circle3.jpg) no-repeat -39px -30px
}
...
#remote-control li#bottom a {
	...
	left: 80px;
	top: 424px;
	background: url(/local/remote-circle3.jpg) no-repeat -39px -112px
}
...
#remote-control li#ok a {
	...
	left: 89px;
	top: 371px;
	background: url(/local/remote-circle3.jpg) no-repeat -48px -59px
}

#remote-control li#exit a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat 0 -157px
}

#remote-control li#info a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -33px -138px
}

#remote-control li#menu a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -75px -138px
}

#remote-control li#back a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -113px -158px
}

#remote-control li#left a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -17px -191px
}

#remote-control li#right a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -98px -191px
}

#remote-control li#top a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -39px -168px
}

#remote-control li#bottom a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -39px -250px
}

#remote-control li#ok a:hover {
	background: url(/local/remote-circle3.jpg) no-repeat -48px -197px
}
    `;
     ...
     <div class="container">
			...
			<div id="remote-control">
				...
				<ul>
					<li class="myButton" id="exit"><a href="#" title="exit full gallery"><span>exit</span></a></li>
					<li class="myButton" id="info"><a href="#" title="Info on gallery"><span>Info</span></a></li>
